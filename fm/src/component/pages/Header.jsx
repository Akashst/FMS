...
export default function Header({ handleDrawerToggle, handleOpenUserMenu, handleCloseNavMenu, handleCloseUserMenu }) {
                ...
                <Toolbar>
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex',} }}>
                        ...
                        <Tooltip title="Open settings" >
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0,m:0.5 }} >
